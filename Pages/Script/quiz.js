    ...
    "investimentos": {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: "Renda Fixa",
                explanation: "CDB é um título de Renda Fixa emitido por bancos para captar recursos. Ao investir em CDB, você está emprestando dinheiro ao banco em troca de uma remuneração definida no momento da aplicação (prefixada, pós-fixada ou híbrida)."
            }
        ]
    },
    "dividas": {
...
async function startQuiz(categoryKey) {
    ...
    if (useGeminiAPI) {
        ...
        try {
            ...
            // Se a API falhar e você cair aqui, o quizArea já foi limpo.
            // Você precisaria restaurar o HTML padrão do quiz aqui para que loadQuestion funcione.
            // Exemplo (se você tiver um template HTML para o quiz):
            // quizArea.innerHTML = `... seu HTML padrão do quiz ...`;
